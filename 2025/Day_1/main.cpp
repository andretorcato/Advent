...
int main(){
	...
	// Opening debug file
	std::string filename = "rotations_debug.txt";
	...
	std::cout << "[e] Example input file :: 2025_day1_input_example.txt" << endl;
	std::cout << "[r] Regular input file :: 2025_day1_input.txt" << endl;
