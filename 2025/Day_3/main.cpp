...
int main(){
	...
	// Opening debug file
	std::string filename = "joltage_debug.txt";
	...
	std::cout << "[e] Example input file :: 2025_day3_input_example.txt" << endl;
	std::cout << "[r] Regular input file :: 2025_day3_input.txt" << endl;
